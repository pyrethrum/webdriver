...
mkActions runner@(MkBiDiRunner {run, socketActions, runWithId, runOffSpecWithId}) =
  MkActions
    { -- Session commands
      ...
      browsingContextSetBypassCSP = run . API.browsingContextSetBypassCSP,
      browsingContextSetViewport = run . API.browsingContextSetViewport,
      browsingContextStartScreencast = run . API.browsingContextStartScreencast,
      browsingContextStopScreencast = run . API.browsingContextStopScreencast,
      ...
      emulationSetScrollbarTypeOverride = run . API.emulationSetScrollbarTypeOverride,
