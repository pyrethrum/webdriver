...
tests :: TestTree
tests =
  withResource getBiDiSession R.closeWDSession runSessionTests
  where
              ...
              [ testGroup
                  ...
                  [ testGroup
                      ...
                      [ chkElmCount
                          ...
                          (autoId "edt-notes-hidden")
                          0,
                        chkElmCount'
                          da {locateAllFn = locateAllNeverCheckDisplayed}
