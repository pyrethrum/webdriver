...
import WebDriverPreCore.BiDi (DriverStatus, ElementId, Selector, SessionId)
import WebDriverPreCore.BiDi qualified as B
...
deleteAllCookies = run . B.deleteAllCookies
